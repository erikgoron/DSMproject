...
%load('joints_bodies');
load('jb_v4.4.1.mat')
Filename='strandbeestDAP_v4.4.3.rtf';
% load('iposvel_v3.2.mat')
%load('bodies_L_at_pi_2_rad.mat');
% load('bodies_R_at_pi_2_rad.mat');

%model Parameters
linDens=1e-2; %linear density of the bars


jointPos=-5.11e-2; % -5.11
...
for k=1:Nrev
    ...
    elseif loc>1
        ...
        a=[-20.91-95,-95,-85,-85+20.91]*1e-2;
        loc48(3:10)=[a,-a];
        b2_loc=loc48(loc);
    elseif loc==-1
        b2_loc=0;
...
forces=[47,0,0,-0.2,0,0;];
%         34,0,0,0,0,1;
%         11,0,0,0,0,1;];
springs=[];
ykc=[-0.59,100000,5000];
